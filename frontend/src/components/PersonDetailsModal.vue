<template>
  <Teleport to="body">
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <!-- Modal -->
      <div class="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-3xl shadow-2xl shadow-black/30 overflow-hidden"
        :class="isDeceased
      ...
      >
        ...
        <div class="flex justify-between items-end px-6 -mt-12 mb-4">
          <div class="w-24 h-24 rounded-2xl overflow-hidden ring-4 ring-white dark:ring-slate-900 shadow-xl flex-shrink-0"
          ...
          >
            <div class="flex flex-col items-end">
              ...
              <span class="text-xs font-semibold opacity-70 leading-none mt-0.5">{{ isDeceased ? $t('person.ageAtDeath') : $t('person.currentAge') }}</span>
            </div>
          </div>
        </div>
        ...
        <div class="px-6 pb-6 max-h-[55vh] overflow-y-auto space-y-4">
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            >
              ...
              >
                <svg class="w-4 h-4" :class="isDeceased ? 'text-gray-500 dark:text-slate-400' : isMale ? 'text-blue-600 dark:text-blue-300' : 'text-pink-600 dark:text-pink-300'"
    ...
    <div v-if="showDeleteConfirm" class="fixed inset-0 z-60 flex items-center justify-center p-4">
      ...
      <div class="relative bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-700 p-6 max-w-xs w-full shadow-2xl">
        <div class="text-center mb-5">
          ...
          <h3 class="text-gray-900 dark:text-white font-bold text-lg mb-1">{{ $t('actions.confirmDelete', { name: person.name }) }}</h3>
