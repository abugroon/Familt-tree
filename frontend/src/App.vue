...
const searchRef        = ref(null)       // mobile search row
const desktopSearchRef = ref(null)       // desktop search box
...
<style scoped>
/* Desktop: header is one row (~65px) */
.tree-canvas-height { height: calc(100dvh - 65px); }

/* Mobile: header is two rows — top row ~57px + search row ~50px */
